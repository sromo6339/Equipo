...
const Hero: React.FC<HeroProps> = ({ onNavigate, activeSection }) => {
  ...
  // SOLO 4 ELEMENTOS: Marketing, Marketing Digital, Publicidad, Marketing
 // SOLO 4 ELEMENTOS: Desarrollo de Marcas, Marketing, Marketing Digital, Publicidad
    ...
    >
      ...
      ">
        ...
        <div className="flex-1 flex flex-col justify-center w-full items-center lg:items-start">
          ...
          {/* Texto animado - SOLO MARKETING, MARKETING DIGITAL, PUBLICIDAD, MARKETING */}
